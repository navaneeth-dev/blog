...
In this blog we will take a look at how to get windows subsystem for android setup to work with burp suite for bug bounties.

Earlier there was only one option which was to use Android Studio emulator with arm64 image. This method is faster, less system intensive and most apps just work.
